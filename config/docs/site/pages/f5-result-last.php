...
<div class="container current-quiz-page-view">
	<div class="row"><h1 class="text-center">F5 Forma2</h1>
		<p class="text-center">Este es tu resultado del último F5!..</p>
	</div>
							...
							<div class="panel-body">
								...
								<div class="col-md-12">
									<div class="rating-block">
										<h4>Tu Puntaje</h4>
										<h2 class="bold padding-bottom-7 quiz-current-points-result"></h2>
											
											<div class="items quiz-current-items-stars">
											</div>
									</div>
								</div>
								<div class="col-md-12">
