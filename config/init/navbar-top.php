...
#search-bar-results{
	...
	border-radius: 15px;
	line-height: 1.8em;
    box-shadow: 7px 7px 2px 0px rgba(0,0,0,.85);
}
	...
	<div class="container-fluid">
		<div class="navbar-header">
			<ul class="nav navbar-nav navbar-right ">
				...
				<!-- BTN DE MUNDIAL -->
				<li title="Mundial" data-toggle="tooltip" data-placement="bottom" class="hideRun item-mundial-navbartop"><a href="#" target="_blank" class="forma2-mundial-link animated rubberBand"><i class="fas fa-futbol"></i></a></li> 
				...
				<li title="Cerrar Sesion" data-toggle="tooltip" data-placement="bottom"><a href="javascript:Forma2.LogOut();	"><i class="glyphicon glyphicon-off"></i></a></li>
