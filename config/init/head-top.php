...
<div class="modal fade" id="modal-view-quiz-current" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="container">
				<div class="row"><h1 class="text-center">F5 Forma2</h1>
					<p class="text-center">Reliza el Quiz y continua navegando en Forma2!..</p>
				</div>
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="panel panel-primary coupon" role="form" method="POST">
							...
							<div class="panel-body">
								...
								<div class="col-md-12">
									<p class="disclosure">
										Bienvenido a la comunidad Forma2. Descubra el valor de un esfuerzo abierto colaborativo por uno de los equipos más grandes del mundo.
									</p>
...
<script>
	...
	function recargarSessionActiva(){
		Forma2.sessionRefresh(function(response) {
			if (response.authResponse) {
	...
	}(document, 'script', 'forma2-jssdk'));

	function testAPI() {
		if(window.location.href == Forma2.options.login_url){ window.location.href = Forma2.options.site_url; };
		console.log('¡Bienvenido! Obteniendo tu información ...');
		/** INICIO **/
			cargarDatosPerfil(); // Cargar Informacion del perfil actual
			$(".spinForma2").hide(); // OCULTAR TODOS LOS SPINNERS
